...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/foucault.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <!-- First Image -->
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/damper.jpg" class="img-fluid rounded z-depth-1 fixed-size-image" %}
        <div class="caption">
    ...
    <!-- Second Image -->
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/giphy_2.gif" class="img-fluid rounded z-depth-1 fixed-size-image" %}
        <div class="caption">
...
<div class="row mt-3 l-gutter">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/Pendulum-no-text.gif" class="img-fluid rounded pendulum" %}
    </div>
</div>
...
<div class="row mt-3 l-page">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/pendulum_motion.gif" class="img-fluid rounded" %}
    </div>
</div>
...
<div class="row mt-3 l-page">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/Vanilla_NN_architecture_transparent.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 l-page">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/PINN_architecture_transparent.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 l-page">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/training_progress_VNN.gif" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 l-page">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/vnn_plot_epoch_30001.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/Vanilla_Model_Loss_History.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 l-page">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/training_progress.gif" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 l-page">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/pinn_prediction_30001.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/model_loss_history_pinn.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 l-screen">
    <!-- First Image -->
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/prediction_outside_training.png" class="img-fluid rounded" %}
        <div class="caption">
    ...
    <!-- Second Image -->
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/pinn_prediction_outside_training.png" class="img-fluid rounded" %}
        <div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/training_progress_DDE_PINN.gif" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 l-page">
    <!-- First Image -->
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/log_error_theta_vnn.png" class="img-fluid rounded" %}
        <div class="caption">
    ...
    <!-- Second Image -->
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/log_error_theta.png" class="img-fluid rounded" %}
        <div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/2560px-Chebyshev_Zeros.svg.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 l-gutter">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/Double_pendulum_predicting_dynamics.gif" class="img-fluid rounded" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/NN_Final_Project/Chaos_Theory_&_Double_Pendulum_-_3.jpg" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
