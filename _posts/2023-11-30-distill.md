...
$$\operatorname{Loss}_{\mathrm{IC}}=\operatorname{MSE}\left(\hat{\theta}_0, \theta_0\right)+\operatorname{MSE}\left(\widehat{\omega}_0, \theta_0\right)$$
...
<div class="caption l-gutter" style="margin-top: -125px;">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/NN_Final_Project/Lorenz_attractor.gif" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
